...
namespace WebApplication2.Controllers
{
    ...
    public class TaskController : ControllerBase
    {
        ...
        public string ContainerName = "TaskCont";
        ...
        public async Task<IActionResult> AddTask(TaskModel taskModel)
        {
            ...
            taskDetails.CreatedByName = "Raviraj";
            taskDetails.CreatedBy = "Raviraj's UID";

            taskDetails.UpdatedOn = DateTime.Now;
            taskDetails.UpdatedByName = "Raviraj";
            taskDetails.UpdatedBy = "Raviraj's Uid";
        ...
        public async Task<IActionResult> UpdateTask(TaskDetails taskDetails)
        {
            ...
            existingtask.UpdatedByName = "Raviraj";
            existingtask.UpdatedBy = "Raviraj's UId";
